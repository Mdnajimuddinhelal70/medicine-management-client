...
const ManageUsers = () => {
  ...
  const handleRoleUpdate = async () => {
    if (selectedUser && selectedRole) {
      ...
      console.log("Selected Role:", selectedRole); // কনসোল লগ দিয়ে ডেটা চেক করা
      axiosSecure
        .patch(`/users/role/${selectedUser._id}`, { role: selectedRole })
        .then((res) => {
          console.log("Response:", res.data); // রেসপন্স চেক করা
          if (res.data.modifiedCount > 0) {
            refetch();
            Swal.fire({
              position: "top-end",
              ...
              <tr key={user._id}>
                ...
                <td>
                  <button
                    ...
                    className="btn btn-md bg-blue-600 text-white"
                  >
